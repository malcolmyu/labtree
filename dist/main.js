...
/***/ function(module, exports, __webpack_require__) {
	...
	var _jsServicesConnectMainpageJs = __webpack_require__(161);

	var _jsServicesConnectMainpageJs2 = _interopRequireDefault(_jsServicesConnectMainpageJs);

	var _jsComponentsMainJsx = __webpack_require__(162);

	var _jsComponentsMainJsx2 = _interopRequireDefault(_jsComponentsMainJsx);

	var _jsActionsMainJs = __webpack_require__(187);

	var _jsActionsMainJs2 = _interopRequireDefault(_jsActionsMainJs);

	var _jsConfigJs = __webpack_require__(193);

	function renderLabTree() {
	  var container = document.createElement('div');

	  if (_jsServicesConnectMainpageJs2['default'].getProjectId()) {
	    document.body.appendChild(container);
	    _react2['default'].render(_react2['default'].createElement(_jsComponentsMainJsx2['default'], null), container);
	    _jsServicesConnectMainpageJs2['default'].scrollTopAccessor(_jsConfigJs.GLOBAL.SCROLL_TOP);
	  }

	  _jsActionsMainJs2['default'].setLeafSelected();
	}

	function recordScrollTop() {
	  // 记录滚动条位置
	  _jsConfigJs.GLOBAL.SCROLL_TOP = _jsServicesConnectMainpageJs2['default'].scrollTopAccessor();
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "@keyframes loading {\n  0% {\n    transform: rotate(0deg); }\n  100% {\n    transform: rotate(360deg); } }\n\n.labtree {\n  top: 0;\n  left: 0;\n  bottom: 0;\n  right: 0;\n  transition: transform 0.2s ease;\n  transform: translate(0, 0);\n  position: fixed !important;\n  padding-top: 46px;\n  width: 270px;\n  background-color: #f9f9f9;\n  border-right: 1px solid #ddd;\n  z-index: 1001;\n  overflow: visible; }\n  .labtree-hidden {\n    transform: translate(-100%, 0); }\n    .labtree-hidden .labtree-toggle {\n      right: -35px; }\n  .labtree .icon {\n    width: 16px;\n    display: inline-block;\n    text-align: right;\n    margin-right: 6px; }\n  .labtree .loader {\n    border-radius: 50%;\n    border: 2px solid #000;\n    border-top: 2px solid transparent;\n    border-left: 2px solid transparent;\n    width: 12px;\n    height: 12px;\n    animation: loading 0.5s infinite linear;\n    display: inline-block; }\n  .labtree-toggle {\n    width: 25px;\n    height: 25px;\n    position: absolute;\n    top: 9px;\n    right: 5px;\n    padding: 6px;\n    text-align: center;\n    line-height: 1;\n    z-index: 1002;\n    cursor: pointer; }\n  .labtree-header {\n    top: 0;\n    left: 0;\n    bottom: 0;\n    right: 0;\n    height: 46px;\n    position: absolute;\n    background: #f1f1f1;\n    text-shadow: 0 1px 0 #fff;\n    border-bottom: 1px solid #ddd;\n    padding-left: 13px;\n    padding-right: 35px; }\n    .labtree-header-repo {\n      white-space: nowrap;\n      overflow: hidden;\n      text-overflow: ellipsis;\n      line-height: 28.428px;\n      font-weight: bold; }\n    .labtree-header-branch {\n      white-space: nowrap;\n      overflow: hidden;\n      text-overflow: ellipsis;\n      line-height: 1; }\n      .labtree-header-branch span {\n        font-size: 12px; }\n    .labtree-header-title {\n      line-height: 46px;\n      font-weight: bold;\n      font-size: 16px; }\n  .labtree-form-row {\n    margin: 13px; }\n  .labtree-form label {\n    font-weight: bold; }\n  .labtree-form-tips {\n    color: #d9534f;\n    padding-left: 10px; }\n  .labtree-view {\n    padding-top: 13px;\n    height: 100%;\n    overflow: auto;\n    position: relative; }\n    .labtree-view .icon {\n      color: #446e9b; }\n  .labtree-list {\n    margin: 0 0 0 15px;\n    padding: 0;\n    list-style: none; }\n    .labtree-list-row {\n      position: absolute;\n      height: auto;\n      width: 100%;\n      left: 0;\n      -webkit-user-select: none; }\n      .labtree-list-row:hover {\n        background: #f1f1f1;\n        transition: background-color 0.15s; }\n    .labtree-list-selected {\n      background: #d9edf7;\n      transition: background-color 0.15s; }\n    .labtree-list li {\n      cursor: pointer;\n      line-height: 24px;\n      white-space: nowrap; }\n      .labtree-list li span {\n        position: relative; }\n      .labtree-list li .loader {\n        border-radius: 50%;\n        border: 2px solid #446e9b;\n        border-top: 2px solid transparent;\n        border-left: 2px solid transparent;\n        width: 12px;\n        height: 12px;\n        animation: loading 0.5s infinite linear;\n        display: inline-block;\n        margin: 0 6px 0 4px; }\n    .labtree-list-hide {\n      display: none; }\n\n.container {\n  transition: padding-left 0.2s ease;\n  padding-left: 0; }\n\n.container-shim {\n  transition: padding-left 0.2s ease;\n  padding-left: 270px; }\n", ""]);
...
/***/ function(module, exports) {
	...
	var handler = {
	  ...
	  getBranchName: function getBranchName() {
	    var repoRef = document.getElementById('repository_ref');
	    return repoRef.value || null;
	  },
	  toggleContainer: function toggleContainer(toggle) {
	    var action = toggle ? 'remove' : 'add';
	  ...
	  executeScript: function executeScript(foo) {
	  ...
	  scrollTopAccessor: function scrollTopAccessor(top) {
	    var treeView = document.getElementsByClassName('labtree-view')[0];
	    if (top) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reflux = __webpack_require__(163);
	...
	var _toggleButtonJsx = __webpack_require__(195);

	var _toggleButtonJsx2 = _interopRequireDefault(_toggleButtonJsx);

	var _loginFormJsx = __webpack_require__(196);

	var _loginFormJsx2 = _interopRequireDefault(_loginFormJsx);

	var _treeViewJsx = __webpack_require__(215);

	var _treeViewJsx2 = _interopRequireDefault(_treeViewJsx);

	var _storesMainJs = __webpack_require__(185);

	var _storesMainJs2 = _interopRequireDefault(_storesMainJs);

	var LabTree = _react2['default'].createClass({
	  displayName: 'LabTree',
	  mixins: [_reflux2['default'].connect(_storesMainJs2['default'], 'main')],

	  render: function render() {
	    var toggle = this.state.main.get('toggle');
	    var logged = this.state.main.get('logged');

	    var navCx = (0, _classnames2['default'])({ 'labtree-hidden': !toggle });

	    var header = logged ? _react2['default'].createElement(_headerJsx2['default'], null) : _react2['default'].createElement(
	      'div',
	      { className: 'labtree-header' },
	      _react2['default'].createElement(
	        'span',
	        { className: 'labtree-header-title' },
	        '用户验证'
	      )
	    );
	    var body = logged ? _react2['default'].createElement(_treeViewJsx2['default'], null) : _react2['default'].createElement(_loginFormJsx2['default'], null);
	    ...
	    return _react2['default'].createElement(
	      ...
	      _react2['default'].createElement(
	        'nav',
	        { className: 'labtree ' + navCx },
	        _react2['default'].createElement(_toggleButtonJsx2['default'], null),
	        header,
	        body
	      )
	    );
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _servicesConnectMainpageJs = __webpack_require__(161);

	var _servicesConnectMainpageJs2 = _interopRequireDefault(_servicesConnectMainpageJs);

	var _storesMainJs = __webpack_require__(185);

	var _storesMainJs2 = _interopRequireDefault(_storesMainJs);

	var _actionsMainJs = __webpack_require__(187);

	var _actionsMainJs2 = _interopRequireDefault(_actionsMainJs);
	...
	var Header = _react2['default'].createClass({
	  ...
	  componentWillMount: function componentWillMount() {
	    ...
	    if (projectId = _servicesConnectMainpageJs2['default'].getProjectId()) {
	      _actionsMainJs2['default'].fetchRepoInfo(projectId);
	    }
	  },

	  render: function render() {
	    var br = _servicesConnectMainpageJs2['default'].getBranchName();
	    var header = this.state.main.get('header');
	    var groupUrl = header ? header.get('groupUrl') : '#';
	    var groupName = header ? header.get('groupName') : '';
	    var repoName = header ? header.get('repoName') : '';
	    var branch = br || (header ? header.get('branch') : 'master');
	    ...
	    return _react2['default'].createElement(
	      ...
	      _react2['default'].createElement(
	        'div',
	        { className: 'labtree-header-repo' },
	        _react2['default'].createElement('i', { className: 'icon icon-book' }),
	        _react2['default'].createElement(
	          'a',
	          { href: groupUrl },
	          groupName
	      ...
	      _react2['default'].createElement(
	        'div',
	        { className: 'labtree-header-branch' },
	        _react2['default'].createElement('i', { className: 'icon icon-code-fork' }),
	        _react2['default'].createElement(
	          'span',
	          { title: branch },
	          branch
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilJs = __webpack_require__(194);
	...
	var _configJs = __webpack_require__(193);

	var logged = !!localStorage.getItem(_configJs.STORAGE_KEY);
	...
	var store = _reflux2['default'].createStore({
	  listenables: _actionsMainJs2['default'],
	  ...
	  onToggleTreeBranch: function onToggleTreeBranch(id) {
	    var tree = state.tree.toJS();
	    var node = getLeafById(tree, id);
	    if (node) {
	      node.toggle = !node.toggle;
	    }
	    state.tree = _immutable2['default'].fromJS(tree);
	    this.refreshState();
	  },

	  onSetTreeBranchLoading: function onSetTreeBranchLoading(id) {
	    var tree = state.tree.toJS();
	    var node = getLeafById(tree, id);
	    if (node) {
	      node.loaded = false;
	  ...
	  onSetLeafSelected: function onSetLeafSelected() {
	    if (state.tree.toJS) {
	      var tree = state.tree.toJS();
	      markSelected(tree);
	      state.tree = _immutable2['default'].fromJS(tree);
	  ...
	  // 登录事件处理
	  onLoginCompleted: function onLoginCompleted(res) {
	    var ret = res.body;
	    var token = ret['private_token'];
	    localStorage.setItem(_configJs.STORAGE_KEY, token);
	    state.logged = true;
	    this.refreshState();
	  },
	  onLoginFailed: function onLoginFailed(res) {
	  ...
	  // 获取repo信息事件处理
	  onFetchRepoInfoCompleted: function onFetchRepoInfoCompleted(res) {
	    var ret = res.body;
	    var branch = _servicesConnectMainpageJs2['default'].getBranchName() || ret['default_branch'];
	    var path = ret['path_with_namespace'];
	    var groupName = ret.namespace.name;

	    if (path === _configJs.GLOBAL.PROJECT && branch === _configJs.GLOBAL.BRANCH) {
	      _configJs.GLOBAL.REPO_INFO_Q.resolve({ branch: branch, path: path });
	    } else {
	      _configJs.GLOBAL.PROJECT = path;
	      _configJs.GLOBAL.BRANCH = branch;
	      _configJs.GLOBAL.REPO_INFO_Q.resolve({ branch: branch, path: path });
	      _configJs.GLOBAL.REPO_INFO_Q = Promise.defer();
	      _configJs.GLOBAL.REPO_INFO_Q.resolve({ branch: branch, path: path });
	    }

	    state.loaded = true;
	    state.header = new _immutable.Map({
	      groupName: groupName,
	  ...
	  onFetchRepoInfoFailed: function onFetchRepoInfoFailed() {
	    // TODO
	  },

	  // 获取tree信息事件处理
	  onFetchTreeInfoCompleted: function onFetchTreeInfoCompleted(ret) {
	    var _ret = _slicedToArray(ret, 3);
	    ...
	    _configJs.GLOBAL.REPO_INFO_Q.promise.then(function (d) {
	      // 填充树的节点数据
	      var treeData = res.map(function (leaf) {
	        var pathName = _utilJs2['default'].getNodePath(path, leaf.name);
	        ...
	        // 添加高亮
	        var reg = new RegExp(leaf.url + '$');
	        leaf.selected = reg.test(url);
	        return leaf;
	      });

	      if (!parentId) {
	        state.tree = _immutable2['default'].fromJS(treeData);
	        _configJs.GLOBAL.TREE_INFO_FETCHED = true;
	      } else {
	        var tree = state.tree.toJS();
	  ...
	  onFetchTreeInfoFailed: function onFetchTreeInfoFailed() {
	    // TODO
	  }
	});
	...
	function getLeafById(tree, id) {
	  ...
	  for (; i < len; i++) {
	    ...
	    if (id === v.id) {
	      ...
	      var node = getLeafById(v.children, id);
	      if (node) {
	        return node;
	      }
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _servicesConnectGitlabJs = __webpack_require__(188);
	...
	actions.login.listenAndPromise(_servicesConnectGitlabJs.login);
	actions.fetchRepoInfo.listenAndPromise(_servicesConnectGitlabJs.fetchRepoInfo);
	actions.fetchTreeInfo.listenAndPromise(_servicesConnectGitlabJs.fetchTreeInfo);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.fetchTreeInfo = fetchTreeInfo;
	...
	var _superagentPromise = __webpack_require__(192);

	var _superagentPromise2 = _interopRequireDefault(_superagentPromise);

	var _connectMainpageJs = __webpack_require__(161);

	var _connectMainpageJs2 = _interopRequireDefault(_connectMainpageJs);

	var _configJs = __webpack_require__(193);

	var agent = (0, _superagentPromise2['default'])(_superagent2['default'], Promise);
	var api = '/api/v3/';
	...
	function login(login, password) {
	  ...
	  return agent.post(api + 'session').query({ login: login, password: password }).end();
	}

	function fetchRepoInfo(id) {
	  var key = localStorage.getItem(_configJs.STORAGE_KEY);
	  return agent.get(api + 'projects/' + id).set('PRIVATE-TOKEN', key).end();
	}

	function fetchTreeInfo(_ref) {
	  var _ref$id = _ref.id;
	  ...
	  var key = localStorage.getItem(_configJs.STORAGE_KEY);
	  var pid = _connectMainpageJs2['default'].getProjectId();
...
/***/ function(module, exports) {
	...
	var STORAGE_KEY = 'labtree_private_key';
...
/***/ function(module, exports) {
	...
	var handler = {
	  getNodePath: function getNodePath(path, name) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ToggleButton = _react2['default'].createClass({
	  ...
	  componentWillMount: function componentWillMount() {
	    var toggle = this.state.main.get('toggle');
	    _servicesConnectMainpageJs2['default'].toggleContainer(!toggle);
	  },

	  toggleSidebar: function toggleSidebar() {
	    var toggle = this.state.main.get('toggle');
	    _servicesConnectMainpageJs2['default'].toggleContainer(toggle);
	    _actionsMainJs2['default'].toggle();
	  },

	  render: function render() {
	    var toggle = this.state.main.get('toggle');
	    var loaded = this.state.main.get('loaded');
	    var logged = this.state.main.get('logged');
	    var iconCx = (0, _classnames2['default'])({
	    ...
	    return _react2['default'].createElement(
	      ...
	      loaded || _react2['default'].createElement('div', { className: 'loader' }),
	      loaded && _react2['default'].createElement('i', { className: 'icon-angle-' + iconCx })
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LoginForm = _reactAddons2['default'].createClass({
	  displayName: 'LoginForm',
	  mixins: [_reactAddons2['default'].addons.LinkedStateMixin, _reflux2['default'].connect(_storesMainJs2['default'], 'main')],
	  ...
	  login: function login(e) {
	    e.preventDefault();
	    _actionsMainJs2['default'].login(this.state.username, this.state.password);
	  },

	  render: function render() {
	    var tip = this.state.main.get('tip');
	    return _reactAddons2['default'].createElement(
	      'form',
	      { onSubmit: this.login, className: 'labtree-form' },
	      _reactAddons2['default'].createElement(
	        'div',
	        { className: 'labtree-form-row' },
	        _reactAddons2['default'].createElement(
	          'label',
	          null,
	          '用户名'
	        ),
	        _reactAddons2['default'].createElement('input', { className: 'form-control',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TreeView = _react2['default'].createClass({
	  ...
	  componentWillMount: function componentWillMount() {
	    _configJs.GLOBAL.TREE_INFO_FETCHED || _actionsMainJs2['default'].fetchTreeInfo({});
	  },

	  visitLink: function visitLink(url, e) {
	    e.preventDefault();
	    e.stopPropagation();
	    var fn = 'Turbolinks.visit(\'' + url + '\')';
	    _servicesConnectMainpageJs2['default'].executeScript(Function(fn));
	  },

	  // 获取子树内容
	  fetchChildrenTree: function fetchChildrenTree(leaf) {
	    var ori = leaf.toJS();
	    var id = ori.id;
	    var path = _utilJs2['default'].getNodePath(ori.path, ori.name);

	    if (ori.type !== 'blob') {
	      if (!ori.toggle && !ori.children) {
	        _actionsMainJs2['default'].setTreeBranchLoading(id);
	        _actionsMainJs2['default'].fetchTreeInfo({ id: id, path: path });
	      } else {
	        _actionsMainJs2['default'].toggleTreeBranch(id);
	      }
	    }
	  },

	  // 渲染单个树叶内容
	  renderLeaf: function renderLeaf(leaf) {
	    var type = leaf.get('type');
	    var isFolder = type !== 'blob';

	    var toggle = leaf.get('toggle');
	    var url = leaf.get('url');
	    var name = leaf.get('name');
	    var loaded = leaf.get('loaded') || !isFolder;
	    var selected = leaf.get('selected');

	    var children = null;

	    var typeCx = (0, _classnames2['default'])({
	      'folder-close': isFolder,
	      'file-alt': !isFolder
	    });
	    var toggleCx = (0, _classnames2['default'])({
	      'down': isFolder && toggle,
	      'right': isFolder && !toggle
	    });
	    var rowCx = (0, _classnames2['default'])({ 'labtree-list-selected': selected });
	    ...
	    return _react2['default'].createElement(
	      ...
	      _react2['default'].createElement(
	        'div',
	        { className: rowCx + ' labtree-list-row',
	          onClick: this.fetchChildrenTree.bind(this, leaf) },
	        ' '
	      ),
	      _react2['default'].createElement(
	        'span',
	        { onClick: this.fetchChildrenTree.bind(this, leaf) },
	        loaded || _react2['default'].createElement('div', { className: 'loader' }),
	        loaded && _react2['default'].createElement('i', { className: 'icon icon-caret-' + toggleCx }),
	        _react2['default'].createElement('i', { className: 'icon icon-' + typeCx }),
	        _react2['default'].createElement(
	          'a',
	          { href: url, onClick: this.visitLink.bind(this, url) },
	          name
	        )
	      ),
	      children
	  ...
	  // 渲染树主干内容
	  renderTrunk: function renderTrunk(data, toggle) {
	    var ulCx = (0, _classnames2['default'])({
	      'show': toggle,
	      'hide': !toggle
	    });
	    var self = this;
	    var list = data.size ? data.map(function (d) {
	      return self.renderLeaf(d);
	    }) : '';

	    return _react2['default'].createElement(
	      'ul',
	      { className: 'labtree-list labtree-list-' + ulCx },
	      list
	    );
	  },

	  render: function render() {
	    var tree = this.state.main.get('tree');

	    return _react2['default'].createElement(
	      'div',
	      { className: 'labtree-view' },
